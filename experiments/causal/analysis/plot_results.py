...
from utils.plot_style import (
    ...
    DOMAIN_COLORS, DOMAIN_COLORS_LIST, TEXT_WIDTH, COL_WIDTH,
)
import matplotlib.ticker as ticker

setup_style()

# Colour palette (EMNLP-compatible)
COLOURS = {
    "cs": DOMAIN_COLORS["cs"],
    "eess": DOMAIN_COLORS["eess"],
    "math": DOMAIN_COLORS["math"],
    "physics": DOMAIN_COLORS["physics"],
    "q-bio": DOMAIN_COLORS["q-bio"],
    "stat": DOMAIN_COLORS["stat"],
    "layer": RES_COLOR,
    "attn": ATTN_COLOR,
    "mlp": MLP_COLOR,
    "shift": "#F39C12",
